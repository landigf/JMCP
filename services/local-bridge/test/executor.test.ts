    ...
    await executor.run(
      {
        ...
        projectMemory: {
          id: "memory_1",
          projectId: "project_1",
          templateName: "jarvis-managed-default",
          templateVersion: "2026-03-23b",
          stackProfile: ["typescript"],
          repoFacts: ["Repo: landigf/JMCP"],
          operatorDefaults: ["Jarvis writes the code."],
          instructions: ["Preserve repo conventions."],
          readmeExcerpt: null,
          createdAt: new Date().toISOString(),
          updatedAt: new Date().toISOString(),
        },
